...
<?php
	class Update 
	{
		...
		function products()
		{
			$sql = "SELECT product_clave_cva, product_category, product_next_update, product_status FROM products WHERE product_clave_cva <> '' AND product_brand = 85 ORDER BY product_clave_cva ASC";
