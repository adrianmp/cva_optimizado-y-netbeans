...
<?php
	class Update 
	{
		...
		{
	   		$this->sXML = $this->download_page('http://www.grupocva.com/catalogo_clientes_xml/lista_precios.xml?cliente=26683&marca=INGRESSIO&grupo%&clave=%&codigo=%&sucursales=1&tc=1&tipo=1&depto=1&dt=1&dc=1&promos=1');
		}
		...
		function products()
		{
			$sql = "SELECT product_clave_cva, product_category, product_next_update, product_status, product_stock FROM products WHERE product_clave_cva <> '' AND product_brand = 122 ORDER BY product_clave_cva ASC";
