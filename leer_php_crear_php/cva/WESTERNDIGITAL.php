...
<?php
	...
	$sql = "SELECT product_clave_cva FROM products WHERE product_clave_cva <> '' AND product_brand = 16 ORDER BY product_clave_cva ASC";
	...
	$sql_new = "SELECT product_clave_cva FROM new_products WHERE product_clave_cva <> '' AND brand_id= 16 ORDER BY product_clave_cva ASC";
	...
	if($row = mysql_fetch_array($product_id))
		...
		$id = 0;
	//////////////////////////////////Grupo cva XML/////////////////////7
	$sXML = download_page('http://www.grupocva.com/catalogo_clientes_xml/lista_precios.xml?cliente=26683&marca=WESTERN%20DIGITAL&grupo%&clave=%&codigo=%&sucursales=1&tc=1&tipo=1&depto=1&dt=1&dc=1&promos=1');
	$product_n=0;
