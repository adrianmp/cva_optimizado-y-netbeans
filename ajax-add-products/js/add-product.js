...
$(document).ready(function() {
	...
	$('.isrepeated').blur(function() {
			...
			$.post("isrepeated.php", { w: w, v: v },
				function(data){
					if(data == "TRUE")
						$("input#" + w).after(' <img class="'+ w +'" src="img/stop.png" alt="Producto Repetido" width="12" height="12" /> ');
					else
						$("input#" + w).after(' <img class="'+ w +'" src="img/accept.png" alt="Producto no Existe" width="12" height="12" /> ');
			});
			return false;
	});
